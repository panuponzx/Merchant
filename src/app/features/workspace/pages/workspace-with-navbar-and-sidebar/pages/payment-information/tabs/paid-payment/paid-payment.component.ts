...
export class PaidPaymentComponent {
  ...
  public columns: CustomColumnModel[] = [
    ...
    { id: 'bankAccount', name: 'Bank Account', label: 'หมายเลขบัตร / บัญชี', prop: 'bankAccountNo', sortable: false, resizeable: true, width: 250, minWidth: 250, headerClass: 'text-break text-center', cellClass: 'text-break text-center', type: 'text' },
