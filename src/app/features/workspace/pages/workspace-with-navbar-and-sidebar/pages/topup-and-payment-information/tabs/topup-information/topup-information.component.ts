...
export class TopupInformationComponent implements OnInit {
  ...
  public columns: CustomColumnModel[] = [
    ...
    { id: 'bankId', name: 'BankId', label: 'ชื่อธนาคาร', prop: 'bankId', sortable: false, resizeable: true, width: 120, minWidth: 120, headerClass: 'text-break text-center', cellClass: 'text-break text-center', type: 'text' },
