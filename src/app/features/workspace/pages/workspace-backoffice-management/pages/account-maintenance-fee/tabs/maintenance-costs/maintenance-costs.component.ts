...
export class MaintenanceCostsComponent implements OnInit {
  ...
  public columns: CustomColumnModel[] = [
    ...
    { id: 'dormantDay', name: 'dormantDay', label: 'ระยะเวลาที่ไม่มีการเคลือนไหว', prop: 'dormantDay', sortable: false, resizeable: true, width: 200, minWidth: 200, headerClass: 'text-break text-center', cellClass: 'text-break text-center', type: 'text' },
