...
export class WalletReportType9Component {
  ...
  ngOnChanges(changes: SimpleChanges) {
    if (changes['refreshTrigger'] && !changes['refreshTrigger'].firstChange && this.walletId) {
      this.onSearch();
    }
  }
  ngOnInit() {
  ...
  _onSearch() {
    ...
    return this.restApiService.postBackOffice("customer-type-9/get-log-wallet", payload) as Observable<IResponseLogModel>;
  }
}
